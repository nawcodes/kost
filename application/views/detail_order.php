    ...
    <div class="col-md-12" style="margin-top: 60px;">
      <div class="card">
          ...
          if($detail->status_pembayaran=='belum_dibayar'){
            if($detail->jenis_pembayaran=='cash'){
              ...
              <div class="alert alert-danger" role="alert">
                ...
                <p class="mb-0">Untuk menyelesaikan pembayaran ini, silakan kontak dengan pemilik tiara kost dan tunjukan halaman ini.</p>
              </div>
              <hr>
              <?php
              ...
              <div class="alert alert-danger" role="alert">
                <h4 class="alert-heading">Silahkan lakukan pembayaran</h4>
                <p class="mb-0">Untuk menyelesaikan pembayaran ini, transfer sejumlah <b><?=rupiah($detail->total_bayar)?></b> ke Rekening 1330004914347 (MANDIRI).<br>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label class="text-purple text-bold">Kost</label>
