...
<head>
  ...
  <title>Tiara Kost Kota Sukabumi</title>
</head>
<body>
  <div class="navbar-title">
  <marquee scrollDelay="30" scrollamount="2" direction="left"><span class="h3">TIARA KOST KOTA SUKABUMI MENERIMA KOST KHUSUS PUTRA/ MAHASISWA/ KARYAWAN</span></marquee>
 </div>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?=base_url('user')?>">Data Penghuni</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?=base_url('apartement')?>">Data Kost</a>
        </li>
        <li class="nav-item">
