          ...
          <div class="row mb-5">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" value="<?= $detail->email ?>" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" disabled>
              </div>
            </div>
            <div class="col-lg-6 d-flex justify-content-center">
              <img src="<?= base_url('assets/images/ktp/') . $detail->img ?>" alt="" width="" style="width:250px; !important">
            </div>
          </div>
